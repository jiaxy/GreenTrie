...
public class CopyOfPathCondition implements Comparable<CopyOfPathCondition> {
    ...
    public static void setReplay(boolean isReplay){
		CopyOfPathCondition.isReplay = isReplay;
	}

    public CopyOfPathCondition() {
    	header = null;
    }
	...
	public CopyOfPathCondition make_copy() {
		CopyOfPathCondition pc_new = new CopyOfPathCondition();
   ...
   /**
	...
	public boolean simplify() {
		...
		if (SymbolicInstructionFactory.greenSolver == null)
			...
			result= simplifyGreen();
		System.out.println(">>>>>>simplify constraint as "+result+" :"+this);
		return result;
	}
	...
	private boolean solveWithSolution() {
		...
		System.out.println("time for solveWithSolution:"+(t2-t1));
		Map<Variable, Variable> vmap=(Map<Variable, Variable>) instance.getData("varMap");
		 Map<Variable, Object> solution=(Map<Variable, Object>) instance.getData("solution");
//		 for(Variable v:vmap.keySet()){
//			 Object value=solution.get(vmap.get(v));
//			 Object o=varsVals.get(v.getName());
//			 if(o instanceof SymbolicInteger){
//				 SymbolicInteger r = (SymbolicInteger) o;
//				 r.solution=(Integer) value;
//			 }
//		 }
	...
	public boolean solveOld() {// warning: solve calls simplify
		...
		solver.cleanup();
		CopyOfPathCondition.flagSolved = true;
	...
	public static CopyOfPathCondition getPC(MJIEnv env) {
	   VM vm = env.getVM();
	   return getPC(vm);
	}

	public static CopyOfPathCondition getPC(VM vm) {
	...
	public boolean equals(Object obj) {
		CopyOfPathCondition p = (CopyOfPathCondition) obj;
		if (count != p.count) {
			return false;
		}
		Constraint c = header;
	 ...
	 */
	@Override
	public int compareTo(CopyOfPathCondition pc) {
		int hc1 = hashCode();
		int hc2 = pc.hashCode();
		if (hc1 < hc2) {
			return -1;
