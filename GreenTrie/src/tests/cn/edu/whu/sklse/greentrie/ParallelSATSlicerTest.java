...
public class ParallelSATSlicerTest {
	...
	@Test
	public void test03() {
		RealVariable v1 = new RealVariable("v1", 0.0, 99.0);
		RealConstant c1 = new RealConstant(0);
		Operation o1 = new Operation(Operation.Operator.EQ, v1, c1);
		RealVariable v2 = new RealVariable("v2", 0.0, 99.0);
		RealConstant c2 = new RealConstant(1);
		Operation o2 = new Operation(Operation.Operator.NE, v2, c2);
		check(o1, o2, "(v1==0.0)&&(v2!=1.0)", "v1==0.0");
	}
