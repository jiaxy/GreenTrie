...
class JavaExample
{
    ...
    void prove(Context ctx, BoolExpr f, boolean useMBQI) throws TestFailedException, Z3Exception
    {
    ...
    public void unsatCoreAndProofExample2(Context ctx) throws Z3Exception
    {
        ...
        System.out.println(solver.getAssertions());
    ...
    public void floatingPointExample1(Context ctx) throws TestFailedException, Z3Exception
    {
    ...
    public void floatingPointExample2(Context ctx) throws TestFailedException, Z3Exception
    {
